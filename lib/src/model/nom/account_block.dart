...
class AccountBlock extends AccountBlockTemplate {
  ...
  AccountBlock.fromJson(Map<String, dynamic> json)
      : descendantBlocks = (json['descendantBlocks'] as List).map((j) => AccountBlock.fromJson(j)).toList(),
    ...
    confirmationDetail =
        json['confirmationDetail'] != null ? AccountBlockConfirmationDetail.fromJson(json['confirmationDetail']) : null;
    pairedAccountBlock = json['pairedAccountBlock'] != null ? AccountBlock.fromJson(json['pairedAccountBlock']) : null;
  }

  @override
  Map<String, dynamic> toJson() {
    final data = super.toJson();
    data['descendantBlocks'] = descendantBlocks.map((block) => block.toJson()).toList();
    ...
    data['confirmationDetail'] = confirmationDetail != null ? confirmationDetail!.toJson() : null;
    data['pairedAccountBlock'] = pairedAccountBlock != null ? pairedAccountBlock!.toJson() : null;
